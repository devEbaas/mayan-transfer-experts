...
import mayanLogo from '@/assets/mayan-logo.jpg';
      ...
      <div style={{ background: 'rgba(245,242,236,.92)', backdropFilter: 'saturate(150%) blur(10px)' }} className="border-b border-border">
        <div className="max-w-[1100px] mx-auto px-6 py-3.5 flex items-center justify-between gap-4 flex-wrap">
          <div onClick={goHome} className="flex items-center gap-3 cursor-pointer flex-none">
            <div
              className="w-14 h-14 rounded-full bg-white flex-none"
              style={{
                boxShadow: '0 6px 16px -6px rgba(14,140,130,.55)',
                backgroundImage: `url(${mayanLogo})`,
                backgroundSize: '76px 103px',
                backgroundPosition: 'center top',
                backgroundRepeat: 'no-repeat',
              }}
            />
            <div className="leading-[1.05] whitespace-nowrap">
              <div className="font-sans font-extrabold text-lg tracking-tight text-navy" style={{ letterSpacing: '-.4px' }}>Mayan Transfer</div>
              <div className="text-[10.5px] tracking-[3px] text-primary font-extrabold">EXPERTS</div>
            </div>
          </div>
