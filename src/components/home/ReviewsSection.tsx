    ...
    <section className="bg-white border-t border-border">
      <div className="max-w-[1080px] mx-auto px-6 py-[74px]">
        <div data-reveal className="text-center max-w-[640px] mx-auto mb-11">
          ...
          <h2 className="font-display font-extrabold leading-[1.06] m-0 text-navy" style={{ fontSize: 'clamp(28px,4vw,40px)', letterSpacing: '-.6px' }}>
            {t('home_testiTitle')}
          </h2>
        </div>
        <div className="grid grid-cols-[repeat(auto-fit,minmax(290px,1fr))] gap-[18px]">
          {testimonials.map((r) => (
            ...
            >
              <div className="text-gold text-base" style={{ letterSpacing: '2px' }}>★★★★★</div>
              <p className="text-[15px] leading-[1.65] m-0 flex-1" style={{ color: '#32405A' }}>"{r.quote}"</p>
              <div className="flex items-center gap-3 border-t pt-3.5" style={{ borderColor: '#EFE6D7' }}>
